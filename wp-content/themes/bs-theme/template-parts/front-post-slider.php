<div id="posts-section" class="section fp-auto-height-responsive" data-anchor="posts">
    ...
    <div class="tw-wrapper pt-20 text-white lg:pt-0 lg:flex lg:items-center">
        <div class="head mb-6 lg:w-1/3 lg:text-left lg:pr-10"><h2
            ...
            <div class="tw-no-widow"><p
                    class="font-work-sans-lt sm:max-w-xl sm:mx-auto lg:ml-0 lg:mb-6 xl:max-w-xs animated delay-p2s">
            ...
            <a href="/blog"
               class="hidden lg:inline-block btn border-bs-blue-dark hover:bg-bs-blue-dark animated delay-p3s">See
                All Blogs</a></div>
        <div class="body relative mb-6 -mx-3 lg:m-0 lg:w-2/3 lg:overflow-x-hidden animated delay-p4s">
                ...
                ?>
                    ...
                    <div class="post my-3 sm:flex-col md:px-2 lg:m-0 lg:flex-grow sm:flex">
                        ...
                        <div class="txt-wrapper bg-white text-black p-4 text-left text-lg leading-tight sm:flex-grow sm:flex sm:flex-col">
                            ...
                            <div class="tw-no-widow hidden lg:block flex-grow mb-2"><p class="font-work-sans-lt text-sm"><?= get_the_excerpt()?></p></div>
