<div class="section fp-noscroll" data-anchor="white-papers">
    ...
    <div class="tw-wrapper text-white lg:flex lg:items-center">
        <div class="head mb-6 lg:w-1/3 lg:text-left lg:pr-10">
            <div class="tw-no-widow hidden lg:block"><p
                    class="animated delay-p2s">

                    <img src="<?=bloginfo('template_directory')?>/images/whitepapers/saveforlatertext.png" alt="">
